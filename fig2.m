...
figure(1);
clf;
repvariance = dlmread('fig2b.dat');   % genrate data from fig2b_data folder
...
actvariance = dlmread('fig2a.dat');    % generate the data from folder fig2a/

axa = 1:0.1:15;
aya = (axa + nstar/2)/tstar;           % curve for minima, analytics
